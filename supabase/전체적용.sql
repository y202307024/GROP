-- ═══════════════════════════════════════════════════════════
-- 전체적용 — 새 DB를 한 번에 세팅합니다
-- ═══════════════════════════════════════════════════════════
-- 01~06 을 순서대로 이어 붙인 파일입니다. 통째로 복사해 Run 하세요.
-- 여러 번 실행해도 안전합니다(이미 있으면 건너뜁니다).
--
-- ⚠️ 07_보안_RLS정리.sql 은 여기 포함돼 있지 않습니다.
--    동작을 바꾸는 스크립트라 팀에 공지한 뒤 따로 실행하세요.
--
-- ⚠️ 이 파일은 자동 생성됩니다. 직접 고치지 말고 01~06 을 고치세요.
-- ═══════════════════════════════════════════════════════════
